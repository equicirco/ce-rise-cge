...
- separate upstream metal supply into real sectors rather than one synthetic
  virgin-metal account.
"""
...
function account_rows()
    return [
        ...
        (
            ...
            overlay_anchor = "",
            notes = "Primary upstream metal-processing sector available directly in FIGARO.",
        ),
        (
            ...
            overlay_anchor = "",
            notes = "Keeps downstream metal components separate from basic metals before they enter final CE-RISE product manufacturing.",
        ),
        (
            account_id = "NEW_ELMA",
        ...
        (
            account_id = "RMTL_EE",
            account_label = "Recovered secondary materials from electronics chains",
            scope = "circular_material",
            stylized_counterpart = "RMTL",
            benchmark_role = "benchmark_sam_account",
            paper_observability = "O",
            observability = "constructed_from_overlay",
            figaro_anchor = "CPA_C24",
            overlay_anchor = "A_*_RECY;M_iw*",
            notes = "Common recycled-material pool built from recycling and industrial-waste recovery nodes connected to the targeted chains.",
        ),
        (
            account_id = "INC_EE",
...
function route_rows()
    return [
        (
            ...
            recycled_material_account = "RMTL_EE",
